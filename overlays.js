/*
 * Creation of intro/outro overlays
 */
...
function createSessionOverlay(topic, channel) {
  var canvas = _createFullScreenCanvas();
  var context = canvas.getContext('2d');
  ...
  tools.wrapText(context, topic, margeX, y, maxWidth, lineHeight);

  _setFontConfig(context, 20);
  context.textAlign = 'right';
  context.fillText(channel, canvas.width - margeX, canvas.height - 25);
